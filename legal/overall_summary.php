...
$query1 = "select distinct case_type from cases";
...
?>
		...
		$query_sum_total = "select * from cases";
		...
		$query_sum_pending = "select * from cases where case_status='pending'";
		...
		$query_sum_disposed = "select * from cases where case_status='disposed'";
		...
		$query_sum_for = "select * from cases where favour='for'";
	//	echo $query_sum_for;
		$result_sum_for=mysqli_query($conn,$query_sum_for);
		$num_of_rows_sum_for=mysqli_num_rows($result_sum_for);
		
		$query_sum_against = "select * from cases where favour='against'";
